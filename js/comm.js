...
$(function(){
	...
	.blur(function(){
		...
		var yzmValue=$(this).val().toLocaleLowerCase();
		var yz=$("#regi-form .regi-yzm .yzm b").text().toLowerCase();
		if(yzmValue!=yz)
		{
			$(this).siblings(".erroTip").show();
		}
	...
	function show_code(){
		...
		$("#regi-form .regi-yzm .yzm b").text(str);
	}
	show_code();
	
	$("#regi-form .regi-yzm .yzm b").click(function(){
		show_code();
	})
